...
// マクロ定義
//**************************************************************
#define WIDTH_FIELD			(5000.0f * 0.5f)		//壁の横幅
#define HEIGHT_FIELD		(5000.0f * 0.5f)		//壁の縦幅
...
//コンストラクタ
//==============================================================
CField::CField(D3DXVECTOR3 pos, D3DXVECTOR3 rot, int nType)
{
	m_nIdxTexture = -1;		//テクスチャの番号
	m_pos = pos;		//位置
	m_nType = nType;	//壁の種類
...
//壁の生成処理
//==============================================================
CField *CField::Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, int nType)
{
	CField *pWall = NULL;
	...
	{//メモリが使用されてなかったら
		...
		//壁の生成
		pWall = new CField(pos, rot, nType);
	}
...
HRESULT CField::Init(void)
{
	...
	//テクスチャの読み込み
	m_nIdxTexture = pTexture->TEX_FIELD;
	...
	//種類の設定
	CObject3D::SetType(CObject::TYPE_FIELD);

	//位置の設定
	CObject3D::SetPos(m_pos);

	//壁の大きさ設定
	CObject3D::SetSize(D3DXVECTOR3(WIDTH_FIELD, 0.0f, HEIGHT_FIELD));
